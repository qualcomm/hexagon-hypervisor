...
sys.path.append(os.path.abspath('scripts/docs'))
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.todo','sphinx.ext.blast']
...
# for source files.
exclude_trees = ['_build','docs','scripts']
...
html_static_path = ['scripts/docs/_static']
