...
/**@ingroup func_qurt_island_attr_delete
  ...
  None.
 */
static inline void qurt_island_attr_delete (qurt_island_attr_t *attr) { }
...
/**@ingroup func_qurt_island_attr_add
  ...
  None.
 */
static inline int qurt_island_attr_add (qurt_island_attr_t *attr, qurt_island_attr_resource_t *resources) { return QURT_EOK; }
...
/**@ingroup func_qurt_island_attr_add_interrupt
  ...
  None.
 */
static inline int qurt_island_attr_add_interrupt (qurt_island_attr_t *attr, unsigned int interrupt) { return QURT_EOK; }
...
/**@ingroup func_qurt_island_attr_add_mem
  ...
  None.
 */
static inline int qurt_island_attr_add_mem (qurt_island_attr_t *attr, qurt_addr_t base_addr, qurt_size_t size) { return QURT_EOK; }
...
/**@ingroup func_qurt_island_attr_add_thread
  ...
  None.
 */
static inline int qurt_island_attr_add_thread  (qurt_island_attr_t *attr, qurt_thread_t thread_id) { return QURT_EOK; }
...
/**@ingroup func_qurt_island_spec_create
  ...
  None.
 */
static inline int qurt_island_spec_create (qurt_island_t *spec_id, qurt_island_attr_t *attr) { return QURT_EOK; }
...
/**@ingroup func_qurt_island_spec_delete
  ...
  None.
 */
static inline int qurt_island_spec_delete (qurt_island_t spec_id) { return QURT_EOK; }
...
/**@ingroup func_qurt_island_enter
  ...
  None.
 */
static inline int qurt_island_enter (qurt_island_t spec_id) { return QURT_ESTM; }
...
/**@ingroup func_qurt_island_exit
  ...
  None.
 */
static inline int qurt_island_exit (void) { return QURT_EOK; }
...
/**@ingroup func_qurt_island_exception_wait
  ...
  None.
*/
static inline unsigned int qurt_island_exception_wait (unsigned int *ip, unsigned int *sp,
                                         unsigned int *badva, unsigned int *cause)
{
	return qurt_exception_wait(ip,sp,badva,cause);
}
...
/**@ingroup func_qurt_island_get_status
  ...
  None.
*/
static inline unsigned int qurt_island_get_status (void) { return 0; }
