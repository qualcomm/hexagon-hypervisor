# Contributing to hexagon-hypervisor
...
1. [Fork](https://github.com/qualcomm/hexagon-hypervisor/fork) and clone the repository.
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/hexagon-hypervisor.git
    ```
