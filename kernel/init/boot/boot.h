...
#define BOOT_TLB_PGSIZE_4K 0  // 4M

#define BOOT_TLB_ADDRBITS 12
#define BOOT_TLB_PGBITS (BOOT_TLB_ADDRBITS + (2*BOOT_TLB_PGSIZE))
#define BOOT_TLB_PGBITS_4K (BOOT_TLB_ADDRBITS + (2*BOOT_TLB_PGSIZE_4K))

#define BOOT_TLB_SHIFT (BOOT_TLB_PGBITS - BOOT_TLB_ADDRBITS)
#define BOOT_TLB_SHIFT_4K (BOOT_TLB_PGBITS_4K - BOOT_TLB_ADDRBITS)
...
#define BOOT_TLBLO_DEV_4K ((1 << BOOT_TLB_PGSIZE_4K) | (4 << TLB_ENTRY_C_BITS) | (BOOT_TLB_PERM << 28))
