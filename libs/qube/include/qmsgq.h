...
/*****************************************************************************/
/*                                                                           */
/*      Q D S P 6   M E S S A G E   Q U E U E   S U B S Y S T E M            */
/*                                                                           */
/* GENERAL DESCRIPTION                                                       */
/* Implements message queue type functionality. This header files will be    */
/* part of the qMsgQClient code.                                             */
/*                                                                           */
/* FUNCTIONS                                                                 */
/*                                                                           */
 ...
 * @return            EFAILED:   IPC related failures,
 * @return            EINVALID:  Wrong channel, attribute pointer, etc,
 * @return            EVAL:      Wrong values for parameters like 
 *                               null value for queue name, channel, buffer, size, etc.
 * @return            EDUP_MSGQ: Duplicate message queue name.
 */
 ...
 * @return            ENO_MSGQ:  Message Queue doesn't exist.
 */
 ...
 * @return             EFAILED:   IPC related failures,
 * @return             EINVALID:  Wrong parameters,
 */
static inline int qmsgq_get_attr(qmsgq_t msgq, qmsgq_attr_t *attr) { memcpy(attr,&msgq->attrs,sizeof(*attr)); return EOK; }

/**
 * Deletes a message queue
 *
 * @param msgq  Message queue object
 * @return      EOK:       delete successful,
 * @return      EFAILED:   IPC related failures,
 * @return      EINVALID:  Wrong parameters.
 */
 ...
 * @return          EOK:       Successful Send,
 * @return          EMEM:      Out of memory error,
 * @return          EFAILED:   IPC related failures,
 * @return          EINVALID:  Wrong parameters,
 * @return          EMAX_MSGS: Message queue is full
 */
 ...
 * @return     EOK:       Successful Send,
 * @return     EINVALID:  Wrong message pointer, message from 
 ...
 * @return               EVAL:      Wrong value for parameters like
 *                                  null data pointer, mode != (BLOCK or NONBLOCK)
 * @return               EINVALID:  Wrong parameters,
 * @return               ENO_MSGS:  No more messages in the queue
 */
