...
s32_t H2K_vmop_status(vmop_t unused0, u32_t vm, u32_t unused2, u32_t unused3, u32_t unused4, u32_t unused5, H2K_thread_context *me) IN_SECTION(".text.misc.vmboot");
