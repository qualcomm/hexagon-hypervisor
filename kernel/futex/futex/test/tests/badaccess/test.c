...
unsigned long long int transtab[] = {
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x00000, H2K_GUEST_START_PAGE + 0x000000,6,0x7,0xf),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x01000, H2K_GUEST_START_PAGE + 0x001000,6,0x7,0xf),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x02000, H2K_GUEST_START_PAGE + 0x002000,6,0x7,0xf),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x03000, H2K_GUEST_START_PAGE + 0x003000,6,0x7,0xf),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x04000, H2K_GUEST_START_PAGE + 0x004000,6,0x7,0xf),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x05000, H2K_GUEST_START_PAGE + 0x005000,6,0x7,0xf),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x06000, H2K_GUEST_START_PAGE + 0x006000,6,0x7,0xf),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x90000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0x0),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x91000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0x1),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x92000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0x2),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x93000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0x3),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x94000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0x4),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x95000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0x5),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x96000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0x6),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x97000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0x7),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x98000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0x8),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x99000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0x9),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x9a000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0xa),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x9b000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0xb),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x9c000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0xc),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x9d000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0xd),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x9e000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0xe),
	TRANS_ENTRY(H2K_GUEST_START_PAGE + 0x9f000, H2K_GUEST_START_PAGE + 0x900000,6,0x7,0xf),
	0,
};
