...
int pthread_mutexattr_getprioceiling(pthread_mutexattr_t *attr, int *ceil);
...
int pthread_mutex_setprioceiling(pthread_mutex_t *mutex, int ceil, int *oldceil);
int pthread_mutex_getprioceiling(pthread_mutex_t *mutex, int *ceil);
