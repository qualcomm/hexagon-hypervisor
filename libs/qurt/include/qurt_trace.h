...
/**@ingroup func_qurt_trace_get_marker
  ...
  None.
*/
static inline unsigned int qurt_trace_get_marker(void) { return 0; }
...
/**@ingroup func_qurt_trace_changed  
  ...
  None.
*/
static inline int qurt_trace_changed(unsigned int prev_trace_marker, unsigned int trace_mask) { return 0; }
...
/**@ingroup func_qurt_etm_testbus_set_config
  ...
  None.
*/
static inline unsigned int qurt_etm_testbus_set_config(unsigned int cfg_data) { return QURT_ETM_SETUP_OK; }
