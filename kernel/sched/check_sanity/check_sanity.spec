...
:cdata:`H2K_kg.ready_validmask`, then we need to make the lowest priority running thread
...
If :cdata:`H2K_kg.runlist_valids` have bits set that are cleared in :cdata:`H2K_kg.ready_validmask`,
...
* input	H2K_kg.runlist_valids	priorities with ready jobs
* input	H2K_kg.ready_valids	priorities of currently running threads
...
* H2K_kg.waitmask == 0
* H2K_kg.waitmask != 0
* H2K_kg.runlist_valids > H2K_kg.ready_valids
* H2K_kg.runlist_valids <= H2K_kg.ready_valids
* H2K_kg.priomask == 0
* H2K_kg.priomask != 0
* H2K_kg.ready_validmask w/ various bits set
