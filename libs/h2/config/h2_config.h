...
static inline int h2_config_set_local_mem(unsigned int base, unsigned int size, unsigned int stride) {
	return h2_config_trap(CONFIG_LOCAL_MEM, base, size, stride, 0);
}
/** @} */
