...
#ifndef BLAST_PTHREAD_H
#define BLAST_PTHREAD_H    1
...
#define UNIMPLEMENTED(FUNC, RETURNTYPE, ARGS)    static inline RETURNTYPE FUNC ARGS { blast_printf("Unimplemented: %s... exiting\n", __FUNCTION__); exit(1); }
 ...
 * @param cpuset     [in] This data set is a bitset where each bit represents 
                          ...
                          For BLAST kernel, Bit 0 is corresponding to hw 
