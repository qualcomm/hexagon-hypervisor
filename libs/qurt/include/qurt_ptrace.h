...
static inline long ptrace(enum __ptrace_request request, unsigned int pid, void*addr, void *data) { if (request == PTRACE_EXT_IS_DEBUG_PERMITTED) return 0; else R_UNSUPPORTED; }
