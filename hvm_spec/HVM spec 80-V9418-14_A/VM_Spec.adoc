...
[NOTE]
====
If an event occurs before GEVB is configured, HVM terminates the current virtual processor (Section 10.4).
====
...
.Virtual interrupt controller
image::virtual_interrupt_controller.svg[]
