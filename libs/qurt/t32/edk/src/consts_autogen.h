...
#define CONTEXT_totalcycles 256
#define CONTEXT_oncpu_start 248
...
#define ERR_OFFSET_LOCAL_SIZE 200
...
#define OFFSET_UTCB_thread_name 40

/*
|| Size of the qurtos_thread_info structure
*/
#define QURTOS_THREAD_INFO_SIZE 80

#define THREAD_INFO_pInvokeSP     76
#define THREAD_INFO_client_handle 56
 ...
 * QURT version string 
 *---------------------------------------------------------*/
#define QURTK_VERSION "QURT Kernel ver.: 02.03.22"
