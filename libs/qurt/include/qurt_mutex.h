...
/**@ingroup func_qurt_mutex_lock
   ...
   None.  
 */
static inline void qurt_mutex_lock(qurt_mutex_t *lock) { h2_mutex_lock(lock); }
...
/**@ingroup func_qurt_mutex_unlock
  ...
  @note1hang The behavior of QuRT is undefined if a thread unlocks a mutex it did not first
   ...
   None.  
 */
static inline void qurt_mutex_unlock(qurt_mutex_t *lock) { h2_mutex_unlock(lock); }
...
/**@ingroup func_qurt_mutex_try_lock
  ...
  None.
 */
static inline int qurt_mutex_try_lock(qurt_mutex_t *lock) { h2_mutex_trylock(lock); }
