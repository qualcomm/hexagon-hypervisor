...
#define BOOT_TLB_PGBITS (BOOT_TLB_ADDRBITS + BOOT_TLB_SHIFT)
#define BOOT_TLB_PGBITS_4M (BOOT_TLB_ADDRBITS + BOOT_TLB_SHIFT_4M)
...
#define BOOT_TLBLO_DEV ((1 << SIZE_4M) | (4 << TLB_ENTRY_C_BITS) | (BOOT_TLB_PERM << 28))
#define SBIT_SIZE 1
#endif
