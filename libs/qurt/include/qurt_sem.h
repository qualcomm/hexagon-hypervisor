 ...
 */
static inline int qurt_sem_add(qurt_sem_t *sem, unsigned int amt) { return h2_sem_add(sem,amt); }
...
/**@ingroup func_qurt_sem_down  
  ...
  - If the count value is zero it is not decremented, and the thread is suspended on the
   ...
   None.
 */
static inline int qurt_sem_down(qurt_sem_t *sem) { return h2_sem_down(sem); }
 ...
 */
static inline int qurt_sem_try_down(qurt_sem_t *sem) { return h2_sem_trydown(sem); }
 ...
 */
static inline void qurt_sem_init(qurt_sem_t *sem) { return h2_sem_init_val(sem,1); }
...
/**@ingroup func_qurt_sem_destroy
  ...
  None.
 */
static inline void qurt_sem_destroy(qurt_sem_t *sem) { }
 ...
 */
static inline void qurt_sem_init_val(qurt_sem_t *sem, unsigned short val) { return h2_sem_init_val(sem,val); }
...
/**@ingroup func_qurt_sem_get_val
  ...
  None.
 */
static inline unsigned short qurt_sem_get_val(qurt_sem_t *sem ){return sem->val;}
static inline int qurt_sem_down_cancellable(qurt_sem_t *sem) { return qurt_sem_down(sem); }
