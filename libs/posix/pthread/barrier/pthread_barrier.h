...
static inline int pthread_barrierattr_destroy(pthread_barrierattr_t *attr) { (void)attr; return 0; }
static inline int pthread_barrierattr_setpshared(pthread_barrierattr_t *attr, int pshared) { (void)attr; (void)pshared; return 0; }
static inline int pthread_barrierattr_getpshared(pthread_barrierattr_t *attr, int *pshared) { (void)attr; *pshared = PTHREAD_PROCESS_SHARED; return 0; }
...
static inline int pthread_barrier_destroy(pthread_barrier_t *barrier) { (void)barrier; return 0; }
