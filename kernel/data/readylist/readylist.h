...
static inline H2K_thread_context *H2K_ready_head(u32_t prio, u32_t hthread) {
	...
	u32_t have = (hthread_xe || hthread_xe3) + hthread_xe2; // # coprocs active on this thread
	...
	u32_t need = (head_xe || head_xe3) + head_xe2; // total coprocs needed by thread at head
