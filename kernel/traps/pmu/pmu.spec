...
.. cfunction:: u32_t H2K_trap_pmuconcig_threadset(u32_t unused, H2K_thread_context *dest, u32_t turnon, u32_t unused3, H2K_thread_context *me)
...
.. cfunction:: u32_t H2K_trap_pmuconcig_threadset(u32_t unused, void *unused2, u32_t whichreg, u32_t newval, H2K_thread_context *me)
