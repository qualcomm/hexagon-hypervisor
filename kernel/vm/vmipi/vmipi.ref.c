...
void H2K_vm_ipi_do(u32_t intno, H2K_thread_context *me, u32_t hthread) {

	ciad(VM_IPI_INTMASK);
	H2K_atomic_clrbit(&H2K_gp->mask_for_ipi, hthread);
...
s32_t H2K_vm_ipi_send_withlock_mask(u32_t mask) {
