...
#define BOOT_TLB_PGNUM (0xff000000 >> BOOT_TLB_ADDRBITS)

#define BOOT_TLBHI ((1 << (TLB_ENTRY_VALID_BIT - 32)) | (1 << (TLB_ENTRY_GLOBAL_BIT - 32)))
#if __QDSP6_ARCH__ <= 3
#define BOOT_TLBLO ((BOOT_TLB_PGSIZE << TLB_ENTRY_SIZE_BITS) | (7 << TLB_ENTRY_C_BITS))
#else
#define BOOT_TLBLO ((1 << BOOT_TLB_PGSIZE) | (7 << TLB_ENTRY_C_BITS))
#endif
