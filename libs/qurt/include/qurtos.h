...
void qurtos_assertion_failed(const char *filename, int lineno) __attribute__((noreturn));

#define qurtos_assert(cond) ((cond)?(void)0:qurtos_assertion_failed(__FILE__,__LINE__))
...
#define qurtos_printf h2_printf
