...
#define CORECFG_BLOCK_SIZE             0x1000
#define CORECFG_BLOCK_COUNT            4
#define CORECFG_ETM_BASE               0x0 * CORECFG_BLOCK_SIZE 
#define CORECFG_LIVELOCK_BASE          0x1 * CORECFG_BLOCK_SIZE 
#define CORECFG_STRIDE_PREFETCHER_BASE 0x2 * CORECFG_BLOCK_SIZE 
#define CORECFG_DPM_VOLTLMTMGMT_BASE   0x3 * CORECFG_BLOCK_SIZE 
#define CORECFG_DPM_VOLTLMTMGMT_MAX    (CORECFG_BLOCK_SIZE - 4)
